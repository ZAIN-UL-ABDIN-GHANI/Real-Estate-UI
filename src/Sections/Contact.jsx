...
function Contact() {
  ...
  return (
    ...
    >
      <section
        className={`${darkMode ? "bg-gray-800" : " light bg-red-100"}
      ...
      >
        ...
        >
          ...
          <button className="bg-red-600 w-full text-md px-8 py-3  text-white  font-semibold rounded-xl hover:bg-black dark:bg-red-700 cursor-pointer">
            SEND EMAIL
          </button>
        </div>
        <div className="flex flex-col justify-center items-start gap-8 lg:p-10 p-2 ">
          ...
          >
            ...
            guidance—making your real estate journey smooth, transparent, and
            truly rewarding. Contact us now to turn your property dreams into
            reality.
          </p>
          <button className="bg-red-600 text-md px-8 py-3  text-white  font-semibold rounded-xl hover:bg-black dark:hover:bg-white dark:hover:text-black cursor-pointer">
            READ MORE
          </button>
        </div>
      </section>
